...
function Admin_Panel() {
  ...
  const [pages, setPages] = useState([
    { pageName: "Admin Settings", html: <Admin_Settings /> },
  ]);
  ...
  return (
    <div className="flex px-[150px] w-full h-full shadow-lg bg-gray-200">
        ...
        <div className="flex items-center mb-[10px]">
          ...
          <p
            onClick={() => {
              ...
              //   pages.unshift({ pageName: "Products", html: <ManageProducts /> });
              //   console.log(pages);
              setPages([
                {
                  pageName: "Products",
                  html: <ManageProducts setPages={setPages} />,
                },
              ]);
            }}
            className={`${
      ...
      {/* Pages Container */}
      <div className="w-2/3 h-auto bg-gray-100">{pages[0]?.html}</div>
    </div>
  );
}
