    ...
    return (
        <>
            ...
            <div className='flex-row content-center text-center'>
                ...
                <div className='w-full mt-[50px]'><H_Divider /></div>
                <p className='text-[20px]'>Can't find what you're looking for? Contact us on Viber!</p>
                <p className='text-[20px]'>at <span className='font-bold'>+63 917-510-1023</span></p>
